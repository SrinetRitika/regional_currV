...
if(!exists("deadWoodCalc")) deadWoodCalc=FALSE 
...
if(!exists("pPRELES_newVcalP_CN")) pPRELES_newVcalP_CN <- pPREL
if(!exists("pCROBAS_newVcalP_CN")) pCROBAS_newVcalP_CN <- pCROB

###reduce krein parameter in order to increase mortality
if(!exists("pCrobasX")) pCrobasX <-pCROBAS_newVcalP_CN
pCrobasX[17,1:3] <- pCROBAS_newVcalP_CN[17,1:3]
...
defaultDir <- "/scratch/project_2000994/srinetri/regional/regional_newV"
